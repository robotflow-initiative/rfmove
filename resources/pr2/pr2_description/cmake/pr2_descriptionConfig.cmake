...
if("FALSE" STREQUAL "TRUE")
  set(pr2_description_SOURCE_PREFIX /tmp/binarydeb/ros-kinetic-pr2-description-1.12.4)
  set(pr2_description_DEVEL_PREFIX /tmp/binarydeb/ros-kinetic-pr2-description-1.12.4/obj-x86_64-linux-gnu/devel)
  ...
  set(pr2_description_INSTALL_PREFIX /opt/ros/kinetic)
...
if(NOT " " STREQUAL " ")
  ...
  set(_include_dirs "")
  if(NOT "https://github.com/PR2/pr2_common/issues " STREQUAL " ")
    set(_report "Check the issue tracker 'https://github.com/PR2/pr2_common/issues' and consider creating a ticket if the problem has not been reported yet.")
  elseif(NOT "http://ros.org/wiki/pr2_description " STREQUAL " ")
    set(_report "Check the website 'http://ros.org/wiki/pr2_description' for information and consider reporting the problem.")
  else()
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'pr2_description' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  ${_report}")
      endif()
    else()
      message(FATAL_ERROR "Project 'pr2_description' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '\${prefix}/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT pr2_description_NUM_DUMMY_TARGETS)
      set(pr2_description_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::pr2_description::wrapped-linker-option${pr2_description_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR pr2_description_NUM_DUMMY_TARGETS "${pr2_description_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::pr2_description::wrapped-linker-option${pr2_description_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND pr2_description_LIBRARIES "${interface_target_name}")
